...
NepomukWebMiner::IndexFolderSelectionDialog::IndexFolderSelectionDialog( QWidget* parent )
    : KDialog( parent )
{
    setupUi( mainWidget() );
    setCaption( i18nc("@title:window Referring to the folders which will be used for the WebMiner lookup", "Customizing Lookup Folders"));
...
NepomukWebMiner::IndexFolderSelectionDialog::~IndexFolderSelectionDialog()
{
}
...
void NepomukWebMiner::IndexFolderSelectionDialog::setFolders( const QStringList& includeDirs, const QStringList& exclude )
{
...
void NepomukWebMiner::IndexFolderSelectionDialog::setIndexHiddenFolders( bool enable )
{
    m_checkShowHiddenFolders->setChecked( enable );
}


QStringList NepomukWebMiner::IndexFolderSelectionDialog::includeFolders() const
{
...
QStringList NepomukWebMiner::IndexFolderSelectionDialog::excludeFolders() const
{
    if ( !indexHiddenFolders() ) {
...
bool NepomukWebMiner::IndexFolderSelectionDialog::indexHiddenFolders() const
{
