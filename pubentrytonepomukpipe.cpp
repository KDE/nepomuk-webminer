...
void PubEntryToNepomukPipe::pipeExport(QList<PublicationEntry*> & bibEntries)
{
    emit progress(0);
    ...
    foreach(PublicationEntry *e, bibEntries ) {
...
void PubEntryToNepomukPipe::setAkonadiAddressbook(Akonadi::Collection & addressbook)
{
...
void PubEntryToNepomukPipe::setSyncDetails(const QString &url, const QString &userid)
{
    m_syncUrl = url;
    m_syncUserId = userid;
}

void PubEntryToNepomukPipe::setProjectPimoThing(Nepomuk::Thing projectThing)
{
    kDebug() << "import bibtex into project thing ::" << projectThing.genericLabel();
    m_projectThing = projectThing;
}

void PubEntryToNepomukPipe::importBibResource(Entry *entry, Nepomuk::SimpleResourceGraph &graph)
{
...
void PubEntryToNepomukPipe::importNote(Entry *e, Nepomuk::SimpleResourceGraph &graph)
{
...
void PubEntryToNepomukPipe::importAttachment(Entry *e, Nepomuk::SimpleResourceGraph &graph)
{
...
void PubEntryToNepomukPipe::addPublicationSubTypes(Nepomuk::NBIB::Publication &publication, Entry *entry)
{
...
void PubEntryToNepomukPipe::handleSpecialCases(Entry *entry, Nepomuk::SimpleResourceGraph &graph, Nepomuk::NBIB::Publication &publication, Nepomuk::NBIB::Reference &reference)
{
...
Entry *PubEntryToNepomukPipe::getDiff(Nepomuk::Resource local, Entry *externalEntry, bool keepLocal, QSharedPointer<Entry> &localEntry)
{
...
void PubEntryToNepomukPipe::merge(Nepomuk::Resource syncResource, Entry *external, bool keepLocal)
{
...
void PubEntryToNepomukPipe::mergeManual(Nepomuk::Resource syncResource, Entry *selectedDiff)
{
    m_replaceMode = true; // tells all functions we call from addContent() to replace the values with the new ones
...
void PubEntryToNepomukPipe::addContent(const QString &key, const Value &value, Nepomuk::NBIB::Publication &publication,
...
void PubEntryToNepomukPipe::addPublisher(const Value &publisherValue, const Value &addressValue, Nepomuk::NBIB::Publication &publication, Nepomuk::SimpleResourceGraph &graph)
{
...
void PubEntryToNepomukPipe::addJournal(const Value &journalValue, const Value &volumeValue, const Value &numberValue,
...
void PubEntryToNepomukPipe::addSpecialArticle(const Value &titleValue, Nepomuk::NBIB::Publication &article, Nepomuk::SimpleResourceGraph &graph, QUrl collectionUrl)
{
...
void PubEntryToNepomukPipe::addAuthor(const Value &contentValue, Nepomuk::NBIB::Publication &publication, Nepomuk::NBIB::Reference &reference, Nepomuk::SimpleResourceGraph &graph, const QString & originalEntryType)
{
...
void PubEntryToNepomukPipe::addSeriesEditor(const Value &contentValue, Nepomuk::NBIB::Publication &publication, Nepomuk::SimpleResourceGraph &graph)
{
    if(m_replaceMode) {
...
void PubEntryToNepomukPipe::addTag(const Value &content, Nepomuk::SimpleResource &resource, Nepomuk::SimpleResourceGraph &graph)
{
    if(m_replaceMode) {
...
void PubEntryToNepomukPipe::addTopic(const Value &content, Nepomuk::SimpleResource &resource, Nepomuk::SimpleResourceGraph &graph)
{
    if(m_replaceMode) {
...
void PubEntryToNepomukPipe::addZoteroSyncDetails(Nepomuk::SimpleResource &mainResource, Nepomuk::SimpleResource &referenceResource,
...
void PubEntryToNepomukPipe::addContact(const Value &contentValue, Nepomuk::SimpleResource &resource, Nepomuk::SimpleResourceGraph &graph, QUrl contactProperty, QUrl contactType )
{
    if(m_replaceMode) {
...
void PubEntryToNepomukPipe::addValueWithLookup(const QString &content, Nepomuk::SimpleResource &resource, QUrl property)
{
    if(m_replaceMode && content.isEmpty()) {
        QList<QUrl> resourceUris;
        if(resource.contains(RDF::type(), NBIB::reference()))
