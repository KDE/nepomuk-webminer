...
namespace Nepomuk2 {
     ...
     * to many groups. 
     */
    class  ContactGroup : public InformationElement
    {
    public:
        /**
         ...
         */
        QStringList contactGroupNames() const;
         ...
         * of the 'ContactGroup' class for details 
         */
        void setContactGroupNames( const QStringList& value );

        /**
         * Add a value to property 'contactGroupName'. The name of the 
         * contact group. This property was NOT defined in the VCARD standard. 
         * See documentation of the 'ContactGroup' class for details 
         */
