...
namespace Nepomuk2 {
     ...
     */
    class  PostalAddress : public ContactMedium
    {
    public:
        /**
         ...
         * the value of the 'ADR' property as defined in RFC 2426, sec. 3.2.1 
         */
        void setRegions( const QStringList& value );

        /**
         * Add a value to property 'region'. Region. Inspired by the fifth 
         ...
         * as defined in RFC 2426, sec. 3.2.1 
         */
        void setCountrys( const QStringList& value );

        /**
         * Add a value to property 'country'. A part of an address specyfing 
         * the country. Inspired by the seventh part of the value of the 
         * 'ADR' property as defined in RFC 2426, sec. 3.2.1 
         */
         ...
         * of a postal address. 
         */
        QList<Resource> addressLocations() const;

        /**
         * Set property 'addressLocation'. The geographical location 
         * of a postal address. 
         */
        void setAddressLocations( const QList<Resource>& value );

        /**
         * Add a value to property 'addressLocation'. The geographical 
         * location of a postal address. 
         */
        void addAddressLocation( const Resource& value );

        /**
         * Get property 'addressLocation'. The geographical location 
         * of a postal address. 
         */
        Resource addressLocation() const;

        /**
         * Set property 'addressLocation'. The geographical location 
         * of a postal address. 
         */
        void setAddressLocation( const Resource& value );
         ...
         * sec. 3.2.1 
         */
        void setPostalcodes( const QStringList& value );

        /**
         * Add a value to property 'postalcode'. Postal Code. Inspired 
         * by the sixth part of the value of the 'ADR' property as defined 
         * in RFC 2426, sec. 3.2.1 
         */
         ...
         * 2426, sec. 3.2.1 
         */
        void setLocalitys( const QStringList& value );

        /**
         * Add a value to property 'locality'. Locality or City. Inspired 
         * by the fourth part of the value of the 'ADR' property as defined 
         * in RFC 2426, sec. 3.2.1 
         */
