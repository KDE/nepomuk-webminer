...
namespace Nepomuk2 {
     ...
     */
    class  ContactMedium : public Resource
    {
    public:
        /**
         ...
         * contact medium. (Deprecated in favor of nie:comment or nao:description 
         ...
         * about the contact medium. (Deprecated in favor of nie:comment 
         * or nao:description - based on the context) 
         */
