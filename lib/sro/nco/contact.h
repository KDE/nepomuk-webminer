 ...
 */
class Contact : public virtual NAO::Party, public virtual NIE::InformationElement, public virtual NCO::Role
{
public:
    Contact(const QUrl& uri = QUrl())
      : SimpleResource(uri), NAO::Party(uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#Contact", QUrl::StrictMode)), NIE::InformationElement(uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#Contact", QUrl::StrictMode)), NCO::Role(uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#Contact", QUrl::StrictMode)) {
    }

    Contact(const SimpleResource& res)
      : SimpleResource(res), NAO::Party(res, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#Contact", QUrl::StrictMode)), NIE::InformationElement(res, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#Contact", QUrl::StrictMode)), NCO::Role(res, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nco#Contact", QUrl::StrictMode)) {
    }
...
protected:
    Contact(const QUrl& uri, const QUrl& type)
      : SimpleResource(uri), NAO::Party(uri, type), NIE::InformationElement(uri, type), NCO::Role(uri, type) {
    }
    Contact(const SimpleResource& res, const QUrl& type)
      : SimpleResource(res), NAO::Party(res, type), NIE::InformationElement(res, type), NCO::Role(res, type) {
    }
};
}
}
