...
namespace Nepomuk2 {
    ...
    public:
        ...
        /**
         * Get property 'article'. Connects an article to its collection 
         * (article in Newspaper, Proceedings, Journalissue) 
         */
        QList<Article> articles() const;

        /**
         * Set property 'article'. Connects an article to its collection 
         * (article in Newspaper, Proceedings, Journalissue) 
         */
        void setArticles( const QList<Article>& value );

        /**
         * Add a value to property 'article'. Connects an article to its 
         * collection (article in Newspaper, Proceedings, Journalissue) 
         */
        void addArticle( const Article& value );

        /**
         * \return The URI of the property 'article'. 
         */
        static QUrl articleUri();
