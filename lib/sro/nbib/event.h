...
namespace Nepomuk2 {
    ...
    public:
        ...
        /**
         * Get property 'eventPublication'. the publications that fornm 
         * the result of an event 
         */
        QList<Publication> eventPublications() const;

        /**
         * Set property 'eventPublication'. the publications that fornm 
         * the result of an event 
         */
        void setEventPublications( const QList<Publication>& value );

        /**
         * Add a value to property 'eventPublication'. the publications 
         * that fornm the result of an event 
         */
        void addEventPublication( const Publication& value );

        /**
         * \return The URI of the property 'eventPublication'. 
         */
        static QUrl eventPublicationUri();
