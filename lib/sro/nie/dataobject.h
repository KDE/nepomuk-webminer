...
public:
     ...
     */
    QList<QDateTime> naoModifieds() const {
     ...
     * States the modification time for a resource 
     */
    void setNaoModifieds(const QList<QDateTime>& value) {
        QVariantList values;
     ...
     * States the modification time for a resource 
     */
    void addNaoModified(const QDateTime& value) {
     ...
     */
    QDateTime nieLastModified() const {
        QDateTime value;
     ...
     * physical representation). Compare with nie:contentLastModified. 
     */
    void setNieLastModified(const QDateTime& value) {
        QVariantList values;
        values << value;
     ...
     * representation). Compare with nie:contentCreated. 
     */
    void setNieCreated(const QDateTime& value) {
        QVariantList values;
        values << value;
     ...
     */
    QList<QDateTime> nieModifieds() const {
        QList<QDateTime> value;
     ...
     * physical representation). Compare with nie:contentModified. 
     */
    void setNieModifieds(const QList<QDateTime>& value) {
        QVariantList values;
        foreach(const QDateTime& v, value)
            values << v;
     ...
     * physical representation). Compare with nie:contentModified. 
     */
    void addNieModified(const QDateTime& value) {
