...
namespace Nepomuk2 {
    ...
    public:
        ...
        /**
         * Get property 'modified'. Date the DataObject was changed in 
         * any way. Note that this date refers to the modification of the 
         * DataObject itself (i.e. the physical representation). Compare 
         * with nie:contentModified. 
         */
        QList<QDateTime> modifieds() const;

        /**
         * Set property 'modified'. Date the DataObject was changed in 
         * any way. Note that this date refers to the modification of the 
         * DataObject itself (i.e. the physical representation). Compare 
         * with nie:contentModified. 
         */
        ...
        /**
         * Add a value to property 'modified'. Date the DataObject was 
         * changed in any way. Note that this date refers to the modification 
         * of the DataObject itself (i.e. the physical representation). 
         * Compare with nie:contentModified. 
         */
        ...
        /**
         * Get property 'lastModified'. Last modification date of the 
         * DataObject. Note that this date refers to the modification 
         * of the DataObject itself (i.e. the physical representation). 
         * Compare with nie:contentLastModified. 
         */
        QList<QDateTime> lastModifieds() const;

        /**
         * Set property 'lastModified'. Last modification date of the 
         * DataObject. Note that this date refers to the modification 
         * of the DataObject itself (i.e. the physical representation). 
         * Compare with nie:contentLastModified. 
         */
        ...
        /**
         * Add a value to property 'lastModified'. Last modification 
         * date of the DataObject. Note that this date refers to the modification 
         * of the DataObject itself (i.e. the physical representation). 
         * Compare with nie:contentLastModified. 
         */
         ...
         */
        QList<QDateTime> lastRefresheds() const;
         ...
         * is an important element of it's dependability. 
         */
        void setLastRefresheds( const QList<QDateTime>& value );

        /**
         * Add a value to property 'lastRefreshed'. Date when information 
         * about this data object was retrieved (for the first time) or 
         * last refreshed from the data source. This property is important 
         * for metadata extraction applications that don't receive any 
         * notifications of changes in the data source and have to poll 
         * it regularly. This may lead to information becoming out of date. 
         * In these cases this property may be used to determine the age 
         * of data, which is an important element of it's dependability. 
         */
        ...
        /**
         * Get property 'coreGraph'. Connects the data object with the 
         * graph that contains information about it. Deprecated in favor 
         * of a more generic nao:isDataGraphFor. 
         */
        QList<Resource> coreGraphs() const;

        /**
         * Set property 'coreGraph'. Connects the data object with the 
         * graph that contains information about it. Deprecated in favor 
         * of a more generic nao:isDataGraphFor. 
         */
        void setCoreGraphs( const QList<Resource>& value );

        /**
         * Add a value to property 'coreGraph'. Connects the data object 
         * with the graph that contains information about it. Deprecated 
         * in favor of a more generic nao:isDataGraphFor. 
         */
        void addCoreGraph( const Resource& value );

        /**
         * \return The URI of the property 'coreGraph'. 
         */
        static QUrl coreGraphUri();

        /**
         * Get property 'byteSize'. The overall size of the data object 
         * in bytes. That means the space taken by the DataObject in its 
         * container, and not the size of the content that is of interest 
         * to the user. For cases where the content size is different (e.g. 
         * in compressed files the content is larger, in messages the content 
         * excludes headings and is smaller) use more specific properties, 
         * not necessarily subproperties of this one. 
         */
        QList<qint64> byteSizes() const;
         ...
         * not necessarily subproperties of this one. 
         */
        void setByteSizes( const QList<qint64>& value );

        /**
         * Add a value to property 'byteSize'. The overall size of the data 
         * object in bytes. That means the space taken by the DataObject 
         * in its container, and not the size of the content that is of interest 
         * to the user. For cases where the content size is different (e.g. 
         * in compressed files the content is larger, in messages the content 
         * excludes headings and is smaller) use more specific properties, 
         * not necessarily subproperties of this one. 
        ...
        /**
         * Get property 'url'. URL of a DataObject. It points to the location 
         * of the object. A typial usage is FileDataObject. In cases where 
         * creating a simple file:// or http:// URL for a file is difficult 
        ...
        /**
         * Set property 'url'. URL of a DataObject. It points to the location 
         * of the object. A typial usage is FileDataObject. In cases where 
         * creating a simple file:// or http:// URL for a file is difficult 
         * (e.g. for files inside compressed archives) the applications 
         * are encouraged to use conventions defined by Apache Commons 
        ...
        /**
         * Add a value to property 'url'. URL of a DataObject. It points 
         * to the location of the object. A typial usage is FileDataObject. 
         * In cases where creating a simple file:// or http:// URL for a 
         * file is difficult (e.g. for files inside compressed archives) 
         * the applications are encouraged to use conventions defined 
         * by Apache Commons VFS Project at http://jakarta.apache.org/ 
         ...
         * filesystems.html. 
         */
        void setUrl( const Resource& value );
