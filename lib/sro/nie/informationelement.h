...
namespace Nepomuk2 {
    ...
    public:
         ...
         */
        QList<QDateTime> contentCreateds() const;
         ...
         * with nie:created property. 
         */
        void setContentCreateds( const QList<QDateTime>& value );

        /**
         * Add a value to property 'contentCreated'. The date of the content 
         * creation. This may not necessarily be equal to the date when 
         * the DataObject (i.e. the physical representation) itself 
         * was created. Compare with nie:created property. 
         */
        ...
        /**
         * Get property 'contentModified'. The date of a modification 
         * of the original content (not its corresponding DataObject 
         * or local copy). Compare with nie:modified. 
         */
        QList<QDateTime> contentModifieds() const;

        /**
         * Set property 'contentModified'. The date of a modification 
         * of the original content (not its corresponding DataObject 
         * or local copy). Compare with nie:modified. 
         */
        ...
        /**
         * Add a value to property 'contentModified'. The date of a modification 
         * of the original content (not its corresponding DataObject 
         * or local copy). Compare with nie:modified. 
         */
        ...
        /**
         * \return The URI of the property 'contentModified'. 
         */
        static QUrl contentModifiedUri();

        /**
         * Get property 'contentLastModified'. The date of the last modification 
         * of the original content (not its corresponding DataObject 
         * or local copy). Compare with nie:lastModified. 
         */
        QList<QDateTime> contentLastModifieds() const;
         ...
         * or local copy). Compare with nie:lastModified. 
         */
        void setContentLastModifieds( const QList<QDateTime>& value );

        /**
         * Add a value to property 'contentLastModified'. The date of 
         * the last modification of the original content (not its corresponding 
        ...
        /**
         * Get property 'htmlContent'. The HTML content of an information 
         * element. This property can be used to store text including formatting 
         * in a generic fashion. 
         */
        QStringList htmlContents() const;

        /**
         * Set property 'htmlContent'. The HTML content of an information 
         * element. This property can be used to store text including formatting 
         * in a generic fashion. 
         */
        void setHtmlContents( const QStringList& value );

        /**
         * Add a value to property 'htmlContent'. The HTML content of an 
         * information element. This property can be used to store text 
         * including formatting in a generic fashion. 
         */
        ...
        /**
         * \return The URI of the property 'htmlContent'. 
         */
        static QUrl htmlContentUri();
         ...
         * 'logical' containment relationships between InformationElements. 
         * NIE extensions are encouraged to provide more specific subproperties 
         * of this one. It is advisable for actual instances of InformationElement 
         * to use those specific subproperties. Note the difference between 
         ...
         * to express 'logical' containment relationships between InformationElements. 
         * NIE extensions are encouraged to provide more specific subproperties 
         * of this one. It is advisable for actual instances of InformationElement 
         * to use those specific subproperties. Note the difference between 
         * 'physical' containment (hasPart) and logical containment 
