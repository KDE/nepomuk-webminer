...
namespace Nepomuk2 {
     ...
     * A font. 
     */
    class  Font : public InformationElement
    {
    public:
        /**
         ...
         * created the font. 
         */
        QList<Resource> foundrys() const;

        /**
         * Set property 'foundry'. The foundry, the organization that 
         * created the font. 
         */
        void setFoundrys( const QList<Resource>& value );

        /**
         * Add a value to property 'foundry'. The foundry, the organization 
         * that created the font. 
         */
        void addFoundry( const Resource& value );

        /**
         * Get property 'foundry'. The foundry, the organization that 
         * created the font. 
         */
        Resource foundry() const;

        /**
         * Set property 'foundry'. The foundry, the organization that 
         * created the font. 
         */
        void setFoundry( const Resource& value );
