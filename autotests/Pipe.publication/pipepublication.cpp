...
/**
 * @file pipepublication.cpp
 *
 * @test UnitTest for the NepomukPipe => Publication.
 *       checks: imports a publication from QVariantList, checks if Nepomuk data is ok
 */
class PipePublication: public QObject
{
    Q_OBJECT

private slots:

    void importPublication();
    void checkImportedPublication();
...
private:
    ...
    QDateTime startDate;
    QVariantMap testArticle;
    //TODO: add more publication types than the article
};

QTEST_KDEMAIN_CORE(PipePublication)

void PipePublication::importPublication()
{
    startDate = QDateTime::currentDateTime();

    // Define the article that will be imported
    testArticle.insert(QLatin1String("bibtexentrytype"), QString::fromUtf8("article"));
    testArticle.insert(QLatin1String("bibtexcitekey"), QString::fromUtf8("UNITTEST-article"));
    testArticle.insert(QLatin1String("address"), QString::fromUtf8("Address"));
    testArticle.insert(QLatin1String("author"), QString::fromUtf8("UNITTEST-A. UNITTEST-Ut; UNITTEST-H. UNITTEST-Ör; UNITTEST-Co UNITTEST-Author; L. Tøffner-Clausen"));
    testArticle.insert(QLatin1String("chapter"), QString::fromUtf8("UNITTEST-II ÄÖÜ"));
    testArticle.insert(QLatin1String("doi"), QString::fromUtf8("10.4204/EPTCS"));
    testArticle.insert(QLatin1String("edition"), QString::fromUtf8("UNITTEST-Second ÄÖÜ"));
    testArticle.insert(QLatin1String("howpublished"), QString::fromUtf8("UNITTEST-Howpublished ÄÖÜ"));
    testArticle.insert(QLatin1String("editor"), QString::fromUtf8("UNITTEST-E.D.I. UNITTEST-Thör; UNITTEST-E. UNITTEST-di UNITTEST-Thor"));
    testArticle.insert(QLatin1String("journal"), QString::fromUtf8("UNITTEST-Journal ÄÖÜ"));
    testArticle.insert(QLatin1String("month"), QString::fromUtf8("jan"));
    testArticle.insert(QLatin1String("note"), QString::fromUtf8("UNITTEST-Note ÄÖÜ"));
    testArticle.insert(QLatin1String("number"), QString::fromUtf8("21"));
    testArticle.insert(QLatin1String("pages"), QString::fromUtf8("1--999"));
    testArticle.insert(QLatin1String("publisher"), QString::fromUtf8("UNITTEST-Publisher ÄÖÜ"));
    testArticle.insert(QLatin1String("series"), QString::fromUtf8("UNITTEST-Series ÄÖÜ"));
    testArticle.insert(QLatin1String("title"), QString::fromUtf8("UNITTEST-Title A: An Article ÄÖÜ"));
    testArticle.insert(QLatin1String("type"), QString::fromUtf8("UNITTEST-Type ÄÖÜ"));
    testArticle.insert(QLatin1String("volume"), QString::fromUtf8("443"));
    testArticle.insert(QLatin1String("year"), QString::fromUtf8("1987"));
    testArticle.insert(QLatin1String("url"), QString::fromUtf8("http://arxiv.org/abs/1009.3306"));
    testArticle.insert(QLatin1String("keywords"), QString::fromUtf8("UNITTEST-Keyword1; UNITTEST-Keyword2; UNITTEST-Keyword3"));


    NepomukWebMiner::Pipe::PublicationPipe pp;
    pp.overrideComponentName(QLatin1String("WebMiner-Unit-Test"));

    bool importSucessful = pp.import(testArticle);

    QVERIFY2( importSucessful == true, "Article import was not possible");

}

void PipePublication::checknames(const Nepomuk2::Resource &r, QStringList &names, const QUrl &property)
{
...
void PipePublication::checkImportedPublication()
{
...
void PipePublication::cleanupTestCase()
{
